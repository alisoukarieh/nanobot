...
export function TabBar({ onMenuClick }: TabBarProps) {
  return (
    <div className="md:hidden h-[52px] flex items-center gap-3 px-4 border-b border-[var(--border)] bg-[var(--topbar-bg)] flex-shrink-0">
      <button onClick={onMenuClick} className="w-9 h-9 flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] border border-[var(--border)]">
